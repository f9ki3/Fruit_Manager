...
<body >
    <div class="header">
        <h1 style="color:  rgb(42, 3, 94)">Fruit Basket Manager</h1>
        <div>
        <div>
                <button style="margin-left: 10px; background-color:  rgb(42, 3, 94); border: 1px solid white; color: white; border: 1px solid gray; border-radius: 10px; width: 10%; padding: 10px; " id="reloadButton" onclick="reFresh()">Refresh</button>
                <button style="margin-left: 10px; background-color:  rgb(42, 3, 94); border: 1px solid white; color: white; border: 1px solid gray; border-radius: 10px; width: 10%; padding: 10px; " id="btnAddCategory">Add Fruit Category</button>
                <button style="margin-left: 10px; background-color:  rgb(42, 3, 94); border: 1px solid white; color: white; border: 1px solid gray; border-radius: 10px; width: 10%; padding: 10px; " id="btnAddBasket">Add Basket Owner</button>
        </div>
        <hr>
        </div>
        ...
        <div style="display: flex;">
            ...
            <div style="width: 20%; display: none" id="div_category">
                <h5 style="font-size: 20px; margin: 5px 0px 10px 10px; font-weight: bolder; color:  rgb(42, 3, 94)">Add Category</h5>
                ...
                <div style="display: flex; flex-direction: row;">
                    ...
                    <button style="margin-left: 10px; background-color:  rgb(42, 3, 94); border: 1px solid white; color: white; border: 1px solid gray; border-radius: 10px; width: 100%; padding: 10px; " onclick="addCategory()">Add </button>
                    <button  style="margin-left: 10px; background-color:  rgb(42, 3, 94); border: 1px solid white; color: white; border: 1px solid gray; border-radius: 10px; width: 100%; padding: 10px; " onclick="reset_category()">Reset </button>
                </div>
            </div >
            <div style="width: 80%; display: none" id="div_owner">
                <h5 style="font-size: 20px; margin: 5px 0px 10px 10px; font-weight: bolder; color:  rgb(42, 3, 94)">Add Basket Owner</h5>
